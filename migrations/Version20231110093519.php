 ...
 */
final class Version20231110093519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user1_id INT NOT NULL, user2_id INT NOT NULL, content LONGTEXT NOT NULL, created_date DATETIME NOT NULL, INDEX IDX_B6BD307F56AE248B (user1_id), INDEX IDX_B6BD307F441B8B65 (user2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
